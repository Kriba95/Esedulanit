    ...
    <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
      <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-gray-900 sm:text-4xl md:mx-auto">
        <span className="relative inline-block">
          ...
          <span className="relative">Esedu</span>
        </span>
        lanit
      </h2>
      ...
      {stage === 1 ? (
        <>
          <div onClick={() => setPage(1)} className="sm:text-center">
            ...
            <h6 className="mb-2 font-semibold leading-5">Ilmoittautuminen</h6>
          </div>
          ...
          <div className="sm:text-center">
            ...
            <h6 className="mb-2 font-semibold leading-5">Vahvista</h6>
          </div>
          ...
          <div className="sm:text-center">
            ...
            <h6 className="mb-2 font-semibold leading-5">Lähetä</h6>
          </div>
        </>
      ) : (
        <>
              ...
              <div onClick={() => setPage(2)} className="sm:text-center">
                <div
                  className={
                    page === 2
                      ? "cursor-pointer flex items-center justify-center w-24 h-24 mb-4 text-5xl font-extrabold rounded-full text-deep-purple-accent-400 bg-gray-900 text-white  sm:mx-auto"
                      : "cursor-pointer flex items-center justify-center w-24 h-24 mb-4 text-5xl font-extrabold rounded-full text-deep-purple-accent-400 bg-green-600 sm:mx-auto"
                  }
                >
                  2
                </div>
